...
<div class="fpptaqb-statistics"><span class="fpptaqb-label">Held:</span> <span id="fpptaqb-statistics-countItemsHeld">{$countItemsHeld}</span>
  <span id="fpptaqb-review-held" {if !$countItemsHeld}style="display:none"{/if}> 
    <a href="{crmURL fb=1 p="civicrm/fpptaqb/helditems/cm"}">Review held credit memos</a>
  </span>
</div>
...
<div class="action-link">
  ...
  {crmButton class="fpptaqb-sync-button" href="#" id="fpptaqb-button-sync" title="Sync this credit memo to QuickBooks" icon="fa-paper-plane"}Sync this item to QuickBooks{/crmButton}
  {crmButton class="fpptaqb-sync-button" href="#" id="fpptaqb-button-sync-retry" title="Try again to sync this credit memo to QuickBooks" icon="fa-paper-plane"}Re-try sync this item to QuickBooks{/crmButton}
  ...
  {crmButton class="fpptaqb-sync-button" href="#" id="fpptaqb-button-next" title="Load the next credit memo" icon="fa-chevron-right"}Load next item{/crmButton}
