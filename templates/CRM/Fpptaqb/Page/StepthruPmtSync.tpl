...
<div class="action-link">
  ...
  {crmButton class="fpptaqb-sync-button" href="#" id="fpptaqb-button-sync" title="Sync this payment to QuickBooks" icon="fa-paper-plane"}Sync this item to QuickBooks{/crmButton}
  ...
  {crmButton class="fpptaqb-sync-button" href="/civicrm/fpptaqb/stepthru/pmt" id="fpptaqb-button-exit" title="Exit this process" icon="fa-times"}Exit the step-through process{/crmButton}
</div>
{else}
