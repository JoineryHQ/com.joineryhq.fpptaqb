...
<pre>
Payment on contribution ID: {$payment.contributionId} <a target="_blank" href="{crmURL p="civicrm/contact/view/contribution" q="reset=1&action=view&cid=`$payment.contributionCid`&id=`$payment.contributionId`"}">View</a>
