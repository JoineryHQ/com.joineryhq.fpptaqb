 ...
 * (GenCodeChecksum:bb98a5e9427a3cfe6d1c35be6cff93ee)
 */
...
class CRM_Fpptaqb_DAO_FpptaquickbooksLog extends CRM_Core_DAO {
  ...
  /**
   * API parameters for the api call which triggered this log entry
   *
   * @var string|null
    ...
    if (!isset(Civi::$statics[__CLASS__]['fields'])) {
      Civi::$statics[__CLASS__]['fields'] = [
        ...
        'api_params' => [
          ...
          'description' => E::ts('API parameters for the api call which triggered this log entry'),
          'maxlength' => 2550,
