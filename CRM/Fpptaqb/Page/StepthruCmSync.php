...
class CRM_Fpptaqb_Page_StepthruCmSync extends CRM_Core_Page {
  ...
  public function run() {
    ...
    CRM_Core_Resources::singleton()->addScriptFile('com.joineryhq.fpptaqb', 'js/CrmFpptaqbPageStepthruCmSync.js');
