      ...
      if (isset($state['state_token']) && $state['state_token'] == $stateToken) {
        ...
        try {
          ...
          $this->output = array(
            ...
            'redirect_url' => '<a href="' . str_replace("&amp;", "&", CRM_Utils_System::url("civicrm/fpptaqbhelper/settings", NULL, TRUE, NULL)) . '">Click here to go back to FPPTA Quickbooks settings page to see the new expiry date of your new access token and key</a>',
          );
          ...
          $this->output = array(
            ...
            'redirect_url' => '<a href="' . str_replace("&amp;", "&", CRM_Utils_System::url("civicrm/fpptaqbhelper/settings", NULL, TRUE, NULL)) . '">Click here to go back to FPPTA Quickbooks settings page and try again.</a>',
          );
        }
      }
    }
    ...
    if (isset($_GET['error'])) {
      ...
      if ($error == "access_denied") {
        ...
        $this->output = array(
          ...
          'redirect_url' => '<a href="' . str_replace("&amp;", "&", CRM_Utils_System::url("civicrm/fpptaqbhelper/settings", NULL, TRUE, NULL)) . '">Click here to go back to FPPTA Quickbooks settings page to authorise the Quickbooks CiviCRM App</a>',
        );
      }
    }
